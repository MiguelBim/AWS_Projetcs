...
def lambda_handler(event, context):
    ...
    body =  """
                ...
                Your lambda function has been triggered! This is a notification that you defined in order to inform you about a new file in a S3 Bucket
    ...
    print("Debug log, lambda function:\n")
